...
| [Blockchain Notarization + eID](https://github.com/nikhilamaragani-jpg/blockchain-autonomous-notarization-e-id) | Security / Digital Identity | Hashing, integrity verification, ledger design, identity concepts |
| [ID Detection & Penalty Mechanism](https://github.com/nikhilamaragani-jpg/id-detection-and-penalty-mechanism) | CV / Compliance Automation | Detection → rules → decision → logging pipeline |
| [Certificates & Achievements](https://github.com/nikhilamaragani-jpg/certificates-achievements) | Credentials | Internships, workshops, continuous upskilling |
...
### 2) Detection of Fake Accounts on Social Media *(Research / Real-Time Project)*

**Problem:** Fake profiles enable spam, scams, and platform abuse; manual review does not scale.  
**Solution:** End-to-end ML pipeline — data prep, feature signals (profile/activity ratios), classifier comparison (Random Forest / Logistic Regression), metrics, prediction logging.  
**Stack:** Python · pandas · scikit-learn · SQLite  
**Repo:** [detection-of-fake-accounts-on-social-media](https://github.com/nikhilamaragani-jpg/detection-of-fake-accounts-on-social-media)
...
### Languages
`Python` · `SQL` · `Java (basic)` · `C (basic)`

### Data & Analytics
`Pandas` · `NumPy` · `Data Preprocessing` · `EDA` · `Power BI` · `Dashboarding`

### Machine Learning & AI
`scikit-learn` · `Classification` · `Feature Engineering` · `Model Evaluation` · `NLP concepts` · `Computer Vision concepts` · `Conversational systems`

### Systems & Tools
`Git` · `GitHub` · `SQLite` · `Jupyter` · `System design (academic)` · `FastAPI (learning)` · `Docker (learning)`

### Core CS
`DSA` · `OOP` · `DBMS` · `OS` · `Computer Networks` · `Software Engineering lifecycle`
...
Full credential list: [certificates-achievements](https://github.com/nikhilamaragani-jpg/certificates-achievements)
