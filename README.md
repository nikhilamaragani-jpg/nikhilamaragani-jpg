...
**Final-year CSE student focused on continuous upskilling and building practical projects end to end.**
...
| Project | Focus | Docs |
|---------|--------|------|
| [**AI Chatbot for Smart Tourism**](https://github.com/nikhilamaragani-jpg/ai-driven-chatbot-smart-tourism) · *Major* | Conversational AI · NLP · retrieval · FastAPI demo | [Interview](https://github.com/nikhilamaragani-jpg/ai-driven-chatbot-smart-tourism/blob/main/docs/INTERVIEW.md) · [Demo](https://github.com/nikhilamaragani-jpg/ai-driven-chatbot-smart-tourism/blob/main/docs/DEMO.md) |
...
Engineering   Git · GitHub · SQLite · modular design · Docker (demos)
...
- Learning practical tools (APIs, evaluation, cleaner system design)  
